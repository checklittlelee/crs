...
<template>
  <div class="product-container">
    <template v-if="property.listStyle == 'listDetail'">
      ...
      >
        <van-image width="114" height="114" :src="item.imgUrl" />
        <div class="content">
          ...
          <div class="flex-box">
            ...
            <div
              v-if="property.purchase === 1"
              class="iconfont icon-shangpingoumai"
            />
          </div>
        </div>
      </div>
    ...
    <template v-if="property.listStyle == 'oneLineOne'">
      <div
        ...
        :class="property.listStyle"
      >
        <van-image width="100%" height="210" :src="item.imgUrl" />
        <div class="content">
          <div class="product-info">
            <p class="title">
              {{ item.jvBrand }}
    ...
    <template v-if="property.listStyle == 'oneLineTwo'">
      ...
      >
        <div
          ...
          :class="property.listStyle"
        >
          <van-image width="160" height="100" :src="item.imgUrl" />
          <div class="content">
            <div class="product-info">
              <p class="title">
                {{ item.jvBrand }}
...
const PRODUCTDEFAULT = [
  { jvBrand: "商品名称", jvCategoryNames: "商品描述", listPrice: 0 },
]
export default {
  name: "Product",
  props: {
